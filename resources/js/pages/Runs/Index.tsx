            ...
            >
                <header className="mb-6 flex items-end justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-base leading-relaxed text-ink dark:text-ink-dark">Semua lari kamu, terbaru di atas.</p>
                    </div>
                </header>
                ...
                {runs.data.length === 0 ? (
                    <div className="rounded-2xl border border-dashed border-line bg-surface-elev/40 p-10 text-center dark:border-line-dark dark:bg-surface-dark-elev/40">
                        ...
                        <p className="mt-3 text-base text-ink dark:text-ink-dark">Belum ada aktivitas yang dianalisis</p>
                    </div>
                ) : (
                    <>
