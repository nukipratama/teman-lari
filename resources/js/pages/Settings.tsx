    ...
    return (
        <AppShell>
            ...
            >
                ...
                <section className="rounded-2xl border border-line bg-surface-elev p-4 sm:p-6">
                ...
                {demoLoginEnabled && (
                    <section className="mt-6 rounded-2xl border border-dashed border-line bg-surface-elev/60 p-4 sm:p-6">
                        <h2 className="text-xs font-semibold uppercase tracking-wider text-ink-3">
                            Demo Mode
                        </h2>
                        <p className="mt-3 text-sm leading-relaxed text-ink">
